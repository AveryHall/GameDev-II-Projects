...
public class CloudCrafter : MonoBehaviour {
	...
	public float cloudSpeedMult = 0.5f; // Adjusts the speed of the clouds in the scene
	...
	void Awake() {
		...
		//Make an array equal in size to the number of clouds we wish to make
		...
		for (int i = 0; i < numClouds; i++) {
			...
			//Pick an int between 0 cloudPrefabs.Length - 1
	...
	void Update () {
		...
		foreach (GameObject cloud in cloudInstances) {
			...
			//If a cloud has moved too far left then
