...
public class Utils : MonoBehaviour {
	...
	public static void SetCameraBounds (Camera cam=null) {
		...
		//Note: This makes a few important assumptions about the camera!
		...
		_camBounds = new Bounds (center, Vector2.zero);
	...
	public static Vector3 BoundsInBoundsCheck ( Bounds bigB, Bounds lilB, BoundsTest test = BoundsTest.onScreen) {
		...
		// to lilB to move it's center back inside bigB
		case BoundsTest.center:

			// The center of lilB is in bigB, do nothing
		...
		// The offScreen test determines what off would have to be applied to move any tiny part of lilB inside of bigB
